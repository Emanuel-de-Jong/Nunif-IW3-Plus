...
1. In `plus/`, run `git clone https://github.com/facebookresearch/sam3.git`, then `cd sam3` and `git checkout -d 5a3143c652ac41c28b788a419b40ec424d0f6aab`.
1. Copy everything except for this `README.md` from `plus/sam3.1_fixes/` to `plus/sam3/`. Overwrite when prompted.
